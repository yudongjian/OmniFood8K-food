...
''' 
- load_for_transfer_learning: load pretrained paramters to models in transfer learning
...
def load_state_dict(checkpoint_path, model, use_ema=False, num_classes=1000, del_posemb=False):
    if checkpoint_path and os.path.isfile(checkpoint_path):
        ...
        if num_classes != 1000:
            # completely discard fully connected for all other differences between pretrained and created models
